#############################################################################
# Makefile for building: eagleeye
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  eagleeye.pro
# Template: subdirs
# Command: /usr/bin/qmake -o Makefile eagleeye.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = eagleeye1.0.0
DISTDIR = /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/.tmp/eagleeye1.0.0
SUBTARGETS    =  \
		sub-eeinstaller \
		sub-eeupdater


sub-eeinstaller-qmake_all:  FORCE
	@test -d eeinstaller/ || mkdir -p eeinstaller/
	cd eeinstaller/ && $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeinstaller/eeinstaller.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
	cd eeinstaller/ && $(MAKE) -f Makefile qmake_all
sub-eeinstaller: FORCE
	@test -d eeinstaller/ || mkdir -p eeinstaller/
	cd eeinstaller/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeinstaller/eeinstaller.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile
sub-eeinstaller-make_first: FORCE
	@test -d eeinstaller/ || mkdir -p eeinstaller/
	cd eeinstaller/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeinstaller/eeinstaller.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile 
sub-eeinstaller-all: FORCE
	@test -d eeinstaller/ || mkdir -p eeinstaller/
	cd eeinstaller/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeinstaller/eeinstaller.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile all
sub-eeinstaller-clean: FORCE
	@test -d eeinstaller/ || mkdir -p eeinstaller/
	cd eeinstaller/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeinstaller/eeinstaller.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile clean
sub-eeinstaller-distclean: FORCE
	@test -d eeinstaller/ || mkdir -p eeinstaller/
	cd eeinstaller/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeinstaller/eeinstaller.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile distclean
sub-eeinstaller-install_subtargets: FORCE
	@test -d eeinstaller/ || mkdir -p eeinstaller/
	cd eeinstaller/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeinstaller/eeinstaller.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile install
sub-eeinstaller-uninstall_subtargets: FORCE
	@test -d eeinstaller/ || mkdir -p eeinstaller/
	cd eeinstaller/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeinstaller/eeinstaller.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile uninstall
sub-eeupdater-qmake_all:  FORCE
	@test -d eeupdater/ || mkdir -p eeupdater/
	cd eeupdater/ && $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeupdater/eeupdater.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
	cd eeupdater/ && $(MAKE) -f Makefile qmake_all
sub-eeupdater: FORCE
	@test -d eeupdater/ || mkdir -p eeupdater/
	cd eeupdater/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeupdater/eeupdater.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile
sub-eeupdater-make_first: FORCE
	@test -d eeupdater/ || mkdir -p eeupdater/
	cd eeupdater/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeupdater/eeupdater.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile 
sub-eeupdater-all: FORCE
	@test -d eeupdater/ || mkdir -p eeupdater/
	cd eeupdater/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeupdater/eeupdater.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile all
sub-eeupdater-clean: FORCE
	@test -d eeupdater/ || mkdir -p eeupdater/
	cd eeupdater/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeupdater/eeupdater.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile clean
sub-eeupdater-distclean: FORCE
	@test -d eeupdater/ || mkdir -p eeupdater/
	cd eeupdater/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeupdater/eeupdater.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile distclean
sub-eeupdater-install_subtargets: FORCE
	@test -d eeupdater/ || mkdir -p eeupdater/
	cd eeupdater/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeupdater/eeupdater.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile install
sub-eeupdater-uninstall_subtargets: FORCE
	@test -d eeupdater/ || mkdir -p eeupdater/
	cd eeupdater/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeupdater/eeupdater.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile uninstall

Makefile: eagleeye.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		eagleeye.pro
	$(QMAKE) -o Makefile eagleeye.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
qmake_all: sub-eeinstaller-qmake_all sub-eeupdater-qmake_all FORCE

make_first: sub-eeinstaller-make_first sub-eeupdater-make_first  FORCE
all: sub-eeinstaller-all sub-eeupdater-all  FORCE
clean: sub-eeinstaller-clean sub-eeupdater-clean  FORCE
distclean: sub-eeinstaller-distclean sub-eeupdater-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) .qmake.stash
install_subtargets: sub-eeinstaller-install_subtargets sub-eeupdater-install_subtargets FORCE
uninstall_subtargets: sub-eeinstaller-uninstall_subtargets sub-eeupdater-uninstall_subtargets FORCE

sub-eeinstaller-check:
	@test -d eeinstaller/ || mkdir -p eeinstaller/
	cd eeinstaller/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeinstaller/eeinstaller.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile check
sub-eeupdater-check:
	@test -d eeupdater/ || mkdir -p eeupdater/
	cd eeupdater/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeupdater/eeupdater.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile check
check: sub-eeinstaller-check sub-eeupdater-check

sub-eeinstaller-benchmark:
	@test -d eeinstaller/ || mkdir -p eeinstaller/
	cd eeinstaller/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeinstaller/eeinstaller.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile benchmark
sub-eeupdater-benchmark:
	@test -d eeupdater/ || mkdir -p eeupdater/
	cd eeupdater/ && ( test -e Makefile || $(QMAKE) -o Makefile /run/media/avouch/Avouch/Avouch/avh02/projects/eagleeye/eeupdater/eeupdater.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile benchmark
benchmark: sub-eeinstaller-benchmark sub-eeupdater-benchmark
